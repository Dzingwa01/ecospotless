...
Route::get('get-valet-requests','WashRequestController@getAvailableRequests');
Route::get('accept-request/{valet}/{request}','WashRequestController@acceptRequest');
Route::get('cancel-request/{client}/{request}','WashRequestController@cancelRequest');