...
<div class="navbar-fixed">
    ...
    <ul id="slide-out" class="sidenav ">
        ...
        <ul class="collapsible popout" style="margin-top:1em;" >
            <li>
                <div class="collapsible-header" style="color:black;font-weight: bolder"> <i class="tiny material-icons">local_car_wash</i><a href="/home" class="" style="color:black;"> Availability</a>
                </div>
                <div class="collapsible-body" >
                </div>
            </li>
