...
<div class="navbar-fixed">
    <nav class="white" role="navigation" style="height: 5em;">
        <div class="nav-wrapper">
            ...
            <a id="logo-container" href="{{url('/home')}}" class="brand-logo center"><img src="{{asset('img/logo.jpg')}}" />
            </a>
    ...
    <ul id="slide-out" class="sidenav ">
        ...
        <ul class="collapsible popout" style="margin-top:1em;" >
            <li>
                <div class="collapsible-header" style="color:black;font-weight: bolder"> <i class="tiny material-icons">local_car_wash</i><a href="/home" class="" style="color:black;"> Book Car Wash</a>
                </div>
                <div class="collapsible-body" >
                </div>
            </li>
        ...
        <ul class="collapsible popout" style="margin-top:1em;" >
            <li>
                <div class="collapsible-header" style="color:black;font-weight: bolder"> <i class="tiny material-icons">history</i><a href="/home" class="" style="color:black;"> History</a>
                </div>
                <div class="collapsible-body" >
                </div>
            </li>
